...
contract VyperDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"VyperDoge";
    string private constant _symbol = unicode"VyperDoge";
