...
contract Pepper {
    ...
    string public name = "t.me/PepperOrMorty Launch today, a spice up dimension hopping chaos with fiery twist";
    string public symbol = "t.me/PepperOrMorty don't let them use you as exit liquidity, join us for a spicy mishap that leads to hilarious pepper-powered escapades!";
